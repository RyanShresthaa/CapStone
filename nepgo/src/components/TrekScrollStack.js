...
import { TREK_LOCATION_PHOTOS as P } from '../data/trekLocationPhotos';      description: "Trek to the base of the world's highest peak, experiencing Sherpa culture and breathtaking Himalayan views.",
    ...
    },
    {
      ...
      rating: 4.8,
      reviews: 89,
      image: P.thorongLa,      description: "Circumnavigate the Annapurna massif through diverse landscapes from subtropical valleys to high alpine passes.",
    ...
    },
    {
      ...
      rating: 4.7,
      reviews: 124,
      image: P.langtangValley,      description: "Explore the beautiful Langtang Valley, known for its stunning glaciers and traditional Tamang villages.",
    ...
    },
    {
      ...
      rating: 4.6,
      reviews: 67,
      image: P.manasluFromTimang,      description: "Trek around the eighth highest peak in the world, experiencing remote villages and pristine landscapes.",
    ...
    },
    {
      ...
      rating: 4.5,
      reviews: 45,
      image: P.loManthang,      description: "Journey to the ancient Kingdom of Lo, a hidden valley with Tibetan culture and dramatic desert landscapes.",
